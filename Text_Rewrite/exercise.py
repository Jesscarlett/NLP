...
doc_path = "C:/Users/Andrew/Documents/AUS-Grade6-Vocab-excercise2.docx"
my_doc = Document(doc_path)

# 5 words in a group
for i in range(61):
    with open('C:/Users/Andrew/Documents/Year6list2.csv', 'r') as file:
        start = i * 5
        n = 0
        finish = start + 5
        print(start)
        ...
        for item in word_list:
            ...
            page_soup = bs(page_html, "html.parser")
            my_divs = page_soup.find_all("tr", {"id": 'gexv2row1'})
